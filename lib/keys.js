...
const keys = {
    ...
    SQUARE_ACCESS_TOKEN: "EAAAlyMbdkmmuk0sS6p-nJ_tJQOk1u_7QH3S4oE8WrKXqnIMcrYp-JXBEn1FrLVW", // sandbox or production token
  SQUARE_APPLICATION_ID: "sq0idp--lGc0dWoMbwafOHvYXQlYA", // app ID
  

    SQUARE_LOCATION_ID:'LEF5GGM3G8DQ6',
    CURRENT_PAYMENT_GATEWAY:'squareup', // 'stripe' or 'squareup' or 'paypal'
    IS_SANDBOX:false,
