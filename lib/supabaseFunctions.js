...
async function insertPaymentLog({ gatewayName, response, amount, endpoint }) {
...
async function logInterceptedRequest(req, extraData = {}) {
  ...
  module.exports = {getPaypalData, updateOrder, updateOrderData,logInterceptedRequest, updateOrderStatus,upsertOrderFailed,insertPaymentLog};
